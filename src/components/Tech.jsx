...
export default function Tech() {
  return (
    ...
    <li><img src={logoReact} alt="" /><p>REACT</p></li>
    <li><img src={logoHtml} alt="" /><p>HTML</p></li>
    <li><img src={logoCSS} alt="" /><p>CSS</p></li>
    <li><img src={logosass} alt="" /><p>SASS</p></li>
    <li><img style={{ marginLeft: ".4rem" }} src={logoJavascript} alt="" /><p>JAVASCRIPT</p></li>
    <li><img src={logoapi} alt="" /><p>API</p></li>
    <li><img src={logofirebase} alt="" /><p>FIREBASE</p></li>
    <li><img src={logovscode} alt="" /><p>VS CODE</p></li>
    <li><img src={logogit} alt="" style={{ marginLeft: ".8rem" }} /><p>GIT</p></li>
    <li><img src={logocypress} alt="" /><p>CYPRESS</p></li>
    <li><img src={logoexpress} alt="" /><p>EXPRESS</p></li>
    <li><img src={logomongodb} alt="" /><p>MONGODB</p></li>
    <li><img src={logonodejs} alt="" /><p>NODE JS</p></li>
      <li><img src={logofigma} alt="" /><p>FIGMA</p></li>
      <li><img src={logotailwind} alt="" /><p>TAILWIND</p></li>
  </ul>
  )
}
